...
\section{Exercises}
\label{vhdl_design_units_exercises}
% be sure to also modify solutions.tex when you change exercises here
...
\item The following two entity declarations each contain two of the most common syntax errors made in VHDL. What are they?
